            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-12 order-2 lg:order-1">
              <div className="layout-content-container flex flex-col max-w-md w-full flex-1">
                <div className="flex flex-col gap-2 mb-8">
                  <h1 className="text-text-light dark:text-text-dark text-4xl font-black leading-tight tracking-[-0.033em]">Đăng Nhập Hệ Thống</h1>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                  ...
                  <div className="flex flex-col gap-4">
                    <div className="flex flex-col w-full flex-1">
                      <label htmlFor="username" className="text-text-light dark:text-text-dark text-base font-medium leading-normal pb-2 cursor-pointer">Tên đăng nhập</label>
                      <div className="flex w-full flex-1 items-stretch rounded-lg">
                        <input 
                          ...
                          className="flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-text-light dark:text-text-dark focus:outline-0 focus:ring-2 focus:ring-primary/50 border border-border-light dark:border-border-dark bg-surface-light dark:bg-surface-dark focus:border-primary h-14 placeholder:text-subtle-light dark:placeholder:text-subtle-dark p-[15px] rounded-r-none border-r-0 pr-2 text-base font-normal leading-normal" 
                          value={username}
                          onChange={(e) => setUsername(e.target.value)}
                        />
                        <div className="text-subtle-light dark:text-subtle-dark flex border border-border-light dark:border-border-dark bg-background-light dark:bg-background-dark items-center justify-center pr-[15px] rounded-r-lg border-l-0">
                          <User size={20} />
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col w-full flex-1">
                      <label htmlFor="password" className="text-text-light dark:text-text-dark text-base font-medium leading-normal pb-2 cursor-pointer">Mật khẩu</label>
                      <div className="flex w-full flex-1 items-stretch rounded-lg">
                        <input 
                          id="password"
                          name="password"
